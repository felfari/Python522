...
# print(user)
#
# firs_name, year, marr = user


# first_name, year, marr = get_user()
# print(first_name, year, marr )
# print(age)
...
# countries = (
#     ("Gemani", 80.2, (('Berline', 3.326), ('Gamburg', 1.715)))
#
# )
# print(countries, end="\n")
# for contry in countries:
#     contryname, contrypopulation = contry
#     print("\nСтрана", contryname, 'Население =', contrypopulation,sep='')
...
# print(s)
# lst = [1,2,2,2,3,1,5,6,8,9]
# lst= ["red", 'green','blac','red']
#
# print(lst)
# num=set(lst)
# print(num)
...
# d = {0:"Text", "one": 45 , (1,2): "кортедж", [5,6,7]: "Список"}
#
# print(d)
